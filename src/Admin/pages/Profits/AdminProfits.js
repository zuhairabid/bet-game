...
function AdminProfits() {
  return (
    <div>
      <div>
        <div className=" py-1  text-center text-[24px] text-white bg-admin-secondary text-white">
          Admin Profits
        </div>
        <div className="bg-white px-2">
          <div className="flex flex-col items-end my-2 p-1">
            <div className="bg-gray-100 shadow w-full css-totxjd flex items-center">
              <div className="css-1iz4iln mr-4">
                <svg
                  stroke="currentColor"
                  fill="currentColor"
                  strokeWidth={0}
