            ...
            <div style={{ height: "auto", overflow: "auto" }}>
              <div className="bg-green-100 my-2 text-admin-primary px-2 py-3 rounded flex items-center flex-row">
                ...
                <div className="flex flex-col ml-3">
                  <span className="text-gray-500 text-xs">Total user</span>
                  <b className="text-md">6.00</b>
                </div>
              </div>
              <div className="bg-green-100 my-2 text-admin-primary px-2 py-3 rounded flex items-center flex-row">
                <div className="bg-admin-primary/10 text-green-700  shadow p-3 rounded">
                ...
                <div className="flex flex-col ml-3">
                  <span className="text-gray-500 text-xs">Total Club</span>
                  <b className="text-md">3.00</b>
                </div>
              </div>
              <div className="bg-green-100 my-2 text-admin-primary px-2 py-3 rounded flex items-center flex-row">
                <div className="bg-admin-primary/10 text-green-700  shadow p-3 rounded">
                ...
                <div className="flex flex-col ml-3">
                  <span className="text-gray-500 text-xs">Total Admin</span>
                  <b className="text-md">5.00</b>
                </div>
              </div>
              <div className="bg-orange-100 my-2 text-admin-primary px-2 py-3 rounded flex items-center flex-row">
                ...
                <div className="flex flex-col ml-3">
                  <span className="text-gray-500 text-xs">Total Game</span>
                  <b className="text-md">21.00</b>
                </div>
              </div>
              <div className="bg-orange-100 my-2 text-admin-primary px-2 py-3 rounded flex items-center flex-row">
                <div className="bg-admin-primary/10 text-orange-500  shadow p-3 rounded">
                ...
                <div className="flex flex-col ml-3">
                  <span className="text-gray-500 text-xs">Total Deposit</span>
              ...
              <div className="bg-green-100 my-2 text-admin-primary px-2 py-3 rounded flex items-center flex-row">
                ...
                <div className="flex flex-col ml-3">
                  <span className="text-gray-500 text-xs">Total Withdraw</span>
                  <b className="text-md">0.00</b>
                </div>
              </div>
              ...
              <div className="bg-orange-100 my-2 text-admin-primary px-2 py-3 rounded flex items-center flex-row">
                ...
                <div className="flex flex-col ml-3">
                  <span className="text-gray-500 text-xs">Total Cashout</span>
                  <b className="text-md">0.00</b>
                </div>
              </div>
            </div>
