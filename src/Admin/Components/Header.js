...
function Header() {
  ...
  return (
    <div className="flex justify-between items-center px-5 py-5">
      <div
        id="sidebar"
        className={`w-full h-screen  top-0 left-0 bg-white/[0.8] z-[100] ${
          sidebarShow ? "fixed" : "hidden"
        }`}
      >
        {/* <div
          className={`transition-[left] transition-linear transition-duration-100 w-2/3 h-screen bg-white text-gray-300 fixed top-0  overflow-scroll ${
            sidebarShow ? "left-0" : "left-[-130vw]"
          }`}
        >
          <div className="flex justify-end items-center p-4">
            <button
              className="ml-3 p-2 bg-white"
              onClick={() => {
                setShowSidebar(!sidebarShow);
              }}
            >
              <svg
                stroke="currentColor"
          ...
          <div>
            <ul
              className="nav nav-pills nav-sidebar flex-column mt-2"
              data-widget="treeview"
              role="menu"
              data-accordion="false"
            >
              <span
                className="px-3 text-gray-800 uppercase text-sm"
              ...
              >
                ...
                <p style={{ fontFamily: "Merriweather, serif" }}>Dashboard</p>
              </a>
              <a
                className="flex items-center text-[15px] p-2 text-gray-700 m-1 rounded"
                href="/admin/abid/notice"
              >
                <span className="mx-4 text-[18px]">
                  <svg
                    stroke="currentColor"
                ...
                <p style={{ fontFamily: "Merriweather, serif" }}>Notice</p>
              </a>
              <a
                className="flex items-center text-[15px] p-2 text-gray-700 m-1 rounded"
                href="/admin/abid/payment-method"
              >
                <span className="mx-4 text-[18px]">
                  <svg
                    stroke="currentColor"
              ...
              >
                ...
                <p style={{ fontFamily: "Merriweather, serif" }}>Settings</p>
              </a>
              <a
                className="flex items-center text-[15px] p-2 text-gray-700 m-1 rounded"
                href="#"
              ...
              <div className=" rounded border-gray-800 flex flex-col undefined">
                <div>
                  <button className="px-3 py-2 text-gray-800 uppercase text-sm  bg-gray-200 mx-2 my-1 rounded flex items-center justify-between ">
                    Game Control
                    <svg
                      stroke="currentColor"
                      fill="currentColor"
              ...
              <div className=" rounded border-gray-800 flex flex-col undefined">
                ...
                <div style={{ height: 0, overflow: "hidden" }}>
                  ...
                  <a
                    className="flex items-center text-[15px] p-2 text-gray-700 m-1 rounded"
                    href="/admin/abid/admin/abid/default/questions-answers"
                  >
                    <span className="mx-4 text-[18px]">
                      <svg
                        stroke="currentColor"
              ...
              <div className=" rounded border-gray-800 flex flex-col undefined">
                ...
                <div style={{ height: 0, overflow: "hidden" }}>
                  <a
                    className="flex items-center text-[15px] p-2 text-gray-700 m-1 rounded"
                    href="/admin/abid/admin/abid/history/bet"
                  >
                    <span className="mx-4 text-[18px]">
                      <svg
                        stroke="currentColor"
                  ...
                  <a
                    className="flex items-center text-[15px] p-2 text-gray-700 m-1 rounded"
                    href="/admin/abid/admin/abid/history/bet-refunds"
                  >
                    <span className="mx-4 text-[18px]">
                      <svg
                        stroke="currentColor"
                  ...
                  <a
                    className="flex items-center text-[15px] p-2 text-gray-700 m-1 rounded"
                    href="/admin/abid/admin/abid/history/bet-cashouts"
                  >
                    <span className="mx-4 text-[18px]">
                      <svg
                        stroke="currentColor"
              ...
              <div className=" rounded border-gray-800 flex flex-col undefined">
                ...
                <div style={{ height: 0, overflow: "hidden" }}>
                  ...
                  <a
                    className="flex items-center text-[15px] p-2 text-gray-700 m-1 rounded"
                    href="/admin/abid/admin/abid/deposits"
                  >
                    <span className="mx-4 text-[18px]">
                      <svg
                        stroke="currentColor"
                  ...
                  <a
                    className="flex items-center text-[15px] p-2 text-gray-700 m-1 rounded"
                    href="/admin/abid/admin/abid/deposits/history"
                  >
                    <span className="mx-4 text-[18px]">
                      <svg
                        stroke="currentColor"
                  ...
                  <a
                    className="flex items-center text-[15px] p-2 text-gray-700 m-1 rounded"
                    href="/admin/abid/admin/abid/withdraws"
                  >
                    <span className="mx-4 text-[18px]">
                      <svg
                        stroke="currentColor"
                  ...
                  <a
                    className="flex items-center text-[15px] p-2 text-gray-700 m-1 rounded"
                    href="/admin/abid/admin/abid/withdraws/history"
                  >
                    <span className="mx-4 text-[18px]">
                      <svg
                        stroke="currentColor"
                  ...
                  <a
                    className="flex items-center text-[15px] p-2 text-gray-700 m-1 rounded"
                    href="/admin/abid/admin/abid/club-withdraws"
                  >
                    <span className="mx-4 text-[18px]">
                      <svg
                        stroke="currentColor"
                  ...
                  <a
                    className="flex items-center text-[15px] p-2 text-gray-700 m-1 rounded"
                    href="/admin/abid/admin/abid/club-withdraws/history"
                  >
                    <span className="mx-4 text-[18px]">
                      <svg
                        stroke="currentColor"
              ...
              <div className=" rounded border-gray-800 flex flex-col undefined">
                ...
                <div style={{ height: 0, overflow: "hidden" }}>
                  ...
                  <a
                    className="flex items-center text-[15px] p-2 text-gray-700 m-1 rounded"
                    href="/admin/abid/admin/abid/to-reseller-balance-transfers"
                  >
                    <span className="mx-4 text-[18px]">
                      <svg
                        stroke="currentColor"
                    ...
                    <p style={{ fontFamily: "Merriweather, serif" }}>
                      User to Super ID Transfers
                    </p>
                  </a>
                  <a
                    className="flex items-center text-[15px] p-2 text-gray-700 m-1 rounded"
                    href="/admin/abid/admin/abid/to-reseller-balance-transfers/history"
                  >
                    <span className="mx-4 text-[18px]">
                      <svg
                        stroke="currentColor"
                  ...
                  <a
                    className="flex items-center text-[15px] p-2 text-gray-700 m-1 rounded"
                    href="/admin/abid/admin/abid/user-to-user-balance-transfer"
                  >
                    <span className="mx-4 text-[18px]">
                      <svg
                        stroke="currentColor"
                  ...
                  <a
                    className="flex items-center text-[15px] p-2 text-gray-700 m-1 rounded"
                    href="/admin/abid/admin/abid/user-to-user-balance-transfer/history"
                  >
                    <span className="mx-4 text-[18px]">
                      <svg
                        stroke="currentColor"
              ...
              <div className=" rounded border-gray-800 flex flex-col undefined">
                ...
                <div style={{ height: 0, overflow: "hidden" }}>
                  <a
                    className="flex items-center text-[15px] p-2 text-gray-700 m-1 rounded"
                    href="/admin/abid/admin/abid/manage-admins"
                  >
                    <span className="mx-4 text-[18px]">
                      <svg
                        stroke="currentColor"
                  ...
                  <a
                    className="flex items-center text-[15px] p-2 text-gray-700 m-1 rounded"
                    href="/admin/abid/admin/abid/manage-users"
                  >
                    <span className="mx-4 text-[18px]">
                      <svg
                        stroke="currentColor"
                  ...
                  <a
                    className="flex items-center text-[15px] p-2 text-gray-700 m-1 rounded"
                    href="/admin/abid/admin/abid/live-users"
                  >
                    <span className="mx-4 text-[18px]">
                      <svg
                        stroke="currentColor"
                  ...
                  <a
                    className="flex items-center text-[15px] p-2 text-gray-700 m-1 rounded"
                    href="/admin/abid/admin/abid/manage-clubs"
                  >
                    <span className="mx-4 text-[18px]">
                      <svg
                        stroke="currentColor"
              ...
              <button className="text-[17px] my-3 bg-orange-600 text-white w-[90%] p-2 rounded mt-5 mx-2 transition-all">
                logout
              </button>
            ...
            >
              ...
              <div className=" rounded border-gray-800 flex flex-col undefined">
                ...
                <div style={{ height: "auto", overflow: "auto" }}>
                  ...
                  <a
                    className="flex items-center text-[15px] p-2 text-gray-700 m-1 rounded"
                    href="/admin/abid/closed-questions"
                  >
                    <span className="mx-4 text-[18px]">
                      <svg
                        stroke="currentColor"
              ...
              <div className=" rounded border-gray-800 flex flex-col undefined">
                ...
                <div style={{ height: "auto", overflow: "auto" }}>
                  <a
                    className="flex items-center text-[15px] p-2 text-gray-700 m-1 rounded"
                    href="/admin/abid/default/question"
                  >
                    <span className="mx-4 text-[18px]">
                      <svg
                        stroke="currentColor"
              ...
              <div className=" rounded border-gray-800 flex flex-col undefined">
                ...
                <div style={{ height: "auto", overflow: "auto" }}>
                  <a
                    className="flex items-center text-[15px] p-2 text-gray-700 m-1 rounded"
                    href="/admin/abid/history/bet-history"
                  >
                    <span className="mx-4 text-[18px]">
                      <svg
                        stroke="currentColor"
                  ...
                  <a
                    className="flex items-center text-[15px] p-2 text-gray-700 m-1 rounded"
                    href="/admin/abid/history/bet-refunds"
                  >
                    <span className="mx-4 text-[18px]">
                      <svg
                        stroke="currentColor"
                  ...
                  <a
                    className="flex items-center text-[15px] p-2 text-gray-700 m-1 rounded"
                    href="/admin/abid/history/bet-cashout"
                  >
                    <span className="mx-4 text-[18px]">
                      <svg
                        stroke="currentColor"
              ...
              <div className=" rounded border-gray-800 flex flex-col undefined">
                ...
                <div style={{ height: "auto", overflow: "auto" }}>
                  ...
                  <a
                    className="flex items-center text-[15px] p-2 text-gray-700 m-1 rounded"
                    href="/admin/abid/deposits/history"
                  >
                    <span className="mx-4 text-[18px]">
                      <svg
                        stroke="currentColor"
                  ...
                  <a
                    className="flex items-center text-[15px] p-2 text-gray-700 m-1 rounded"
                    href="/admin/abid/withdraws/history"
                  >
                    <span className="mx-4 text-[18px]">
                      <svg
                        stroke="currentColor"
                  ...
                  <a
                    className="flex items-center text-[15px] p-2 text-gray-700 m-1 rounded"
                    href="/admin/abid/club-withdraws"
                  >
                    <span className="mx-4 text-[18px]">
                      <svg
                        stroke="currentColor"
                  ...
                  <a
                    className="flex items-center text-[15px] p-2 text-gray-700 m-1 rounded"
                    href="/admin/abid/club-withdraws/history"
                  >
                    <span className="mx-4 text-[18px]">
                      <svg
                        stroke="currentColor"
              ...
              <div className=" rounded border-gray-800 flex flex-col undefined">
                ...
                <div style={{ height: "auto", overflow: "auto" }}>
                  ...
                  <a
                    className="flex items-center text-[15px] p-2 text-gray-700 m-1 rounded"
                    href="/admin/abid/to-reseller-balance-transfers"
                  >
                    <span className="mx-4 text-[18px]">
                      <svg
                        stroke="currentColor"
                  ...
                  <a
                    className="flex items-center text-[15px] p-2 text-gray-700 m-1 rounded"
                    href="/admin/abid/to-reseller-balance-transfers/history"
                  >
                    <span className="mx-4 text-[18px]">
                      <svg
                        stroke="currentColor"
                  ...
                  <a
                    className="flex items-center text-[15px] p-2 text-gray-700 m-1 rounded"
                    href="/admin/abid/user-to-user-balance-transfer"
                  >
                    <span className="mx-4 text-[18px]">
                      <svg
                        stroke="currentColor"
                  ...
                  <a
                    className="flex items-center text-[15px] p-2 text-gray-700 m-1 rounded"
                    href="/admin/abid/user-to-user-balance-transfer/history"
                  >
                    <span className="mx-4 text-[18px]">
                      <svg
                        stroke="currentColor"
      ...
      <div className="relative p-2 px-4">
        ...
        <span className="absolute top-0 right-0">10</span>
      </div>
      <div>
