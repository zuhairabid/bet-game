            ...
            >
              ...
              <div className=" rounded border-gray-800 flex flex-col undefined">
                ...
                <div style={{ height: 0, overflow: "hidden" }}>
                  ...
                  <a
                    className="flex items-center text-[15px] p-2 text-gray-700 m-1 rounded"
                    href="/admin/abid/bplt20-super-admin-latest-2023-admin-xyzabc/default/questions-answers"
                  >
                    <span className="mx-4 text-[18px]">
                      <svg
                        stroke="currentColor"
              ...
              <div className=" rounded border-gray-800 flex flex-col undefined">
                ...
                <div style={{ height: 0, overflow: "hidden" }}>
                  <a
                    className="flex items-center text-[15px] p-2 text-gray-700 m-1 rounded"
                    href="/admin/abid/bplt20-super-admin-latest-2023-admin-xyzabc/history/bet"
                  >
                    <span className="mx-4 text-[18px]">
                      <svg
                        stroke="currentColor"
                  ...
                  <a
                    className="flex items-center text-[15px] p-2 text-gray-700 m-1 rounded"
                    href="/admin/abid/bplt20-super-admin-latest-2023-admin-xyzabc/history/bet-refunds"
                  >
                    <span className="mx-4 text-[18px]">
                      <svg
                        stroke="currentColor"
                  ...
                  <a
                    className="flex items-center text-[15px] p-2 text-gray-700 m-1 rounded"
                    href="/admin/abid/bplt20-super-admin-latest-2023-admin-xyzabc/history/bet-cashouts"
                  >
                    <span className="mx-4 text-[18px]">
                      <svg
                        stroke="currentColor"
              ...
              <div className=" rounded border-gray-800 flex flex-col undefined">
                ...
                <div style={{ height: 0, overflow: "hidden" }}>
                  ...
                  <a
                    className="flex items-center text-[15px] p-2 text-gray-700 m-1 rounded"
                    href="/admin/abid/bplt20-super-admin-latest-2023-admin-xyzabc/deposits"
                  >
                    <span className="mx-4 text-[18px]">
                      <svg
                        stroke="currentColor"
                  ...
                  <a
                    className="flex items-center text-[15px] p-2 text-gray-700 m-1 rounded"
                    href="/admin/abid/bplt20-super-admin-latest-2023-admin-xyzabc/deposits/history"
                  >
                    <span className="mx-4 text-[18px]">
                      <svg
                        stroke="currentColor"
                  ...
                  <a
                    className="flex items-center text-[15px] p-2 text-gray-700 m-1 rounded"
                    href="/admin/abid/bplt20-super-admin-latest-2023-admin-xyzabc/withdraws"
                  >
                    <span className="mx-4 text-[18px]">
                      <svg
                        stroke="currentColor"
                  ...
                  <a
                    className="flex items-center text-[15px] p-2 text-gray-700 m-1 rounded"
                    href="/admin/abid/bplt20-super-admin-latest-2023-admin-xyzabc/withdraws/history"
                  >
                    <span className="mx-4 text-[18px]">
                      <svg
                        stroke="currentColor"
                  ...
                  <a
                    className="flex items-center text-[15px] p-2 text-gray-700 m-1 rounded"
                    href="/admin/abid/bplt20-super-admin-latest-2023-admin-xyzabc/club-withdraws"
                  >
                    <span className="mx-4 text-[18px]">
                      <svg
                        stroke="currentColor"
                  ...
                  <a
                    className="flex items-center text-[15px] p-2 text-gray-700 m-1 rounded"
                    href="/admin/abid/bplt20-super-admin-latest-2023-admin-xyzabc/club-withdraws/history"
                  >
                    <span className="mx-4 text-[18px]">
                      <svg
                        stroke="currentColor"
              ...
              <div className=" rounded border-gray-800 flex flex-col undefined">
                ...
                <div style={{ height: 0, overflow: "hidden" }}>
                  ...
                  <a
                    className="flex items-center text-[15px] p-2 text-gray-700 m-1 rounded"
                    href="/admin/abid/bplt20-super-admin-latest-2023-admin-xyzabc/to-reseller-balance-transfers"
                  >
                    <span className="mx-4 text-[18px]">
                      <svg
                        stroke="currentColor"
                  ...
                  <a
                    className="flex items-center text-[15px] p-2 text-gray-700 m-1 rounded"
                    href="/admin/abid/bplt20-super-admin-latest-2023-admin-xyzabc/to-reseller-balance-transfers/history"
                  >
                    <span className="mx-4 text-[18px]">
                      <svg
                        stroke="currentColor"
                  ...
                  <a
                    className="flex items-center text-[15px] p-2 text-gray-700 m-1 rounded"
                    href="/admin/abid/bplt20-super-admin-latest-2023-admin-xyzabc/user-to-user-balance-transfer"
                  >
                    <span className="mx-4 text-[18px]">
                      <svg
                        stroke="currentColor"
                  ...
                  <a
                    className="flex items-center text-[15px] p-2 text-gray-700 m-1 rounded"
                    href="/admin/abid/bplt20-super-admin-latest-2023-admin-xyzabc/user-to-user-balance-transfer/history"
                  >
                    <span className="mx-4 text-[18px]">
                      <svg
                        stroke="currentColor"
              ...
              <div className=" rounded border-gray-800 flex flex-col undefined">
                ...
                <div style={{ height: 0, overflow: "hidden" }}>
                  <a
                    className="flex items-center text-[15px] p-2 text-gray-700 m-1 rounded"
                    href="/admin/abid/bplt20-super-admin-latest-2023-admin-xyzabc/manage-admins"
                  >
                    <span className="mx-4 text-[18px]">
                      <svg
                        stroke="currentColor"
                  ...
                  <a
                    className="flex items-center text-[15px] p-2 text-gray-700 m-1 rounded"
                    href="/admin/abid/bplt20-super-admin-latest-2023-admin-xyzabc/manage-users"
                  >
                    <span className="mx-4 text-[18px]">
                      <svg
                        stroke="currentColor"
                  ...
                  <a
                    className="flex items-center text-[15px] p-2 text-gray-700 m-1 rounded"
                    href="/admin/abid/bplt20-super-admin-latest-2023-admin-xyzabc/live-users"
                  >
                    <span className="mx-4 text-[18px]">
                      <svg
                        stroke="currentColor"
                  ...
                  <a
                    className="flex items-center text-[15px] p-2 text-gray-700 m-1 rounded"
                    href="/admin/abid/bplt20-super-admin-latest-2023-admin-xyzabc/manage-clubs"
                  >
                    <span className="mx-4 text-[18px]">
                      <svg
                        stroke="currentColor"
